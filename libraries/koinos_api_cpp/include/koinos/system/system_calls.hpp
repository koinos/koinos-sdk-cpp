...
void apply_block( const types::protocol::block& block, bool enable_check_passive_data, bool enable_check_block_signature, bool enabled_check_transaction_signatures );
...
types::multihash hash( uint64_t code, const types::variable_blob& obj, uint64_t size = 0 );
